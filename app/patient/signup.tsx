...
import { ArrowLeft, Calendar, Lock, Mail, MapPin, Phone, Sparkles, User } from "lucide-react-native";
...
import { filterNameInput, filterNumberInput, filterPhoneInput, isValidEmail, validatePassword } from '../../utils/validation';
...
export default function UserInfoScreen() {
    ...
    const handleSubmit = async () => {
        ...
        if (!cleanAge) newErrors.age = 'Age is required';
    ...
    return (
        <>
            ...
            />
            <SafeAreaView style={{ flex: 1, height: '100%' }} className="bg-white">
                <KeyboardAvoidingView
