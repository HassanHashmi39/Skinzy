...
import { Calendar, Camera, Shield, Star, Sparkles } from 'lucide-react-native';
    ...
    <View className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View className="flex-col md:flex-row gap-4 items-center animate-fade-in-bottom">
            <TouchableOpacity
              onPress={() => router.push('/patient/scan' as any)}
              className="px-8 bg-purple-600 py-4 rounded-full flex-row items-center justify-center gap-3 shadow-xl shadow-purple-200 transition-all duration-300 hover:bg-purple-900 hover:scale-105 active:scale-95 group"
            >
            ...
            <TouchableOpacity
              onPress={() => router.push('/patient/products' as any)}
              className="px-8 bg-white border-2 border-purple-600 py-4 rounded-full flex-row items-center justify-center gap-3 shadow-md transition-all duration-300 hover:bg-purple-50 hover:scale-105 active:scale-95 group"
            >
              <Sparkles size={20} color="#9333EA" className="group-hover:scale-110 transition-transform duration-300" />
              <Text className="text-purple-600 font-bold text-lg">Browse Products</Text>
            </TouchableOpacity>
          </View>
