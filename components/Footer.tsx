    ...
    <View className="bg-gray-50 border-t border-gray-100 px-6 py-12 w-full mt-10">
      <View className={`max-w-7xl mx-auto w-full ${isMobile ? 'flex-col gap-10' : 'flex-row justify-between gap-8'}`}>
        ...
        <View className={`${isMobile ? 'w-full' : 'w-1/4'}`}>
          ...
          <View className="gap-3">
            <TouchableOpacity onPress={() => router.push('/patient/appointments')}><Text className="text-gray-600 transition-colors duration-300 hover:text-purple-600 hover:underline">Appointments</Text></TouchableOpacity>
            <TouchableOpacity onPress={() => router.push('/patient/products')}><Text className="text-gray-600 transition-colors duration-300 hover:text-purple-600 hover:underline">Product Recommendations</Text></TouchableOpacity>
            <TouchableOpacity onPress={() => router.push('/patient/routine')}><Text className="text-gray-600 transition-colors duration-300 hover:text-purple-600 hover:underline">Routine Tracker</Text></TouchableOpacity>
          </View>
        </View>
